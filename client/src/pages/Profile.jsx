  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form  onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        Erro Image Upload (image must be less than 2 mb)
          </span>
          ...
          {`Uploading' ${filePerc}%`}
            ...
            <span className='text-green-700'>
             Image sucessfully uploaded!</span>
          )
          :
          ''
      }
        ...
        <input type='passwoed' placeholder='password' id='password'
        className='border p-3 rounded-lg'
        />

        <button disabled={loading} className='bg-slate-700 text-white rounded-lg 
        p-3 uppercase hover:opacity-95 diabled:opacity-80'> {loading ? 'loading...' : 'update'}
        </button>
      </form>
